...
@Autonomous(name = "Left Auto |Gone Cone", group = "Competition")
public class LeftGrabFast extends RoadRunnerAutoBase {
    Arm arm;
    Claw claw;
    Slides slides;
    Brace brace;
...
//                })
                ...
                .addTemporalMarkerOffset(0.1, () -> {
                    slides.setTargetPosition(RobotConfig.Presets.SlidesHighFromRev+300);
