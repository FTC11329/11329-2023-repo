...
//                })
                ...
                .splineToLinearHeading(new Pose2d(90 , 76, Math.toRadians(80 )), Math.toRadians(70))
                ...
                //.waitSeconds(1)
                .lineToLinearHeading(new Pose2d(69., 40.6, Math.toRadians(60)))
